...
import { create_house_block } from "@/action"
import ModalAction from "@/app/_components/modal-action"

export default function Modal() {
    return (
        <ModalAction name="Buat blok rumah" action={create_house_block} success="Berhasil buat blok rumah" button_name="Buat" button_type={1}>
            <>
